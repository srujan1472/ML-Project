          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-8">
                  Upload an image containing text to extract and analyze it using AI-powered OCR technology.
                </p>
                ...
                <div className="space-y-6">
                  ...
                  {ocrError && (
                    <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-5">
                      ...
                      <p className="text-red-700 dark:text-red-300">{ocrError}</p>
                    </div>
                  )}
        ...
        {showOcrCamera && (
          <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-2xl max-w-md w-full">
              <div className="relative">
                <div className="flex justify-between items-center p-5 border-b border-gray-200 dark:border-gray-700">
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">OCR Camera</h3>
                  <button 
                    onClick={() => { setShowOcrCamera(false); stopOcrCamera(); }} 
                    className="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-500 dark:text-gray-400 transition-colors"
                  >
                    <X size={20} />
                  </button>
