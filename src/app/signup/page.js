...
export default function SignupScreen() {
  ...
  return (
    <>
      <Head>
        <title>Sign Up - Food Scanner</title>
        <meta
          name="description"
          content="Create your account to start scanning food safely"
        />
          ...
          <div className="w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-4xl">
            <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-8 lg:gap-16">
              ...
              <div className="hidden lg:flex flex-col items-center lg:items-start text-center lg:text-left lg:flex-1">
                ...
                <h1
                  className={`text-4xl xl:text-6xl font-bold mb-4 animate-fade-in-up animation-delay-200 ${
                ...
                <p
                  className={`text-xl xl:text-2xl mb-8 animate-fade-in-up animation-delay-400 ${
                    isDark ? "text-gray-300" : "text-gray-600"
                  }`}
                >
                  Join us to scan food safely
                </p>
                <div
                  className={`text-lg animate-fade-in-up animation-delay-600 ${
              ...
              <div className="w-full max-w-md lg:max-w-lg xl:max-w-xl lg:flex-1">
                <div
                  className={`backdrop-blur-sm rounded-3xl p-8 sm:p-10 shadow-2xl border animate-fade-in-up animation-delay-800 ${
                    isDark
                  ...
                  <form onSubmit={handleSignup} className="space-y-6">
                      ...
                      >
                        <div
                          className={`p-4 transition-transform duration-200 ${
                            nameFocused ? "scale-110" : "scale-100"
                          }`}
                        >
                          <svg
                            className={`w-5 h-5 ${
                          ...
                          >
                            {showPassword ? (
                              <path
                                ...
                                strokeLinejoin="round"
                                strokeWidth="2"
                                d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L8.464 8.464m1.414 1.414L8.464 8.464m5.656 5.656l1.415 1.415m-1.415-1.415l-2.829-2.829m0 0a3 3 0 01-4.243-4.243m4.243 4.243L8.464 8.464"
                              />
                            ) : (
                              <path
                                strokeLinecap="round"
                    ...
                    <div className="relative">
                      ...
                      >
                        <div
                          className={`p-4 transition-transform duration-200 ${
                            confirmPasswordFocused ? "scale-110" : "scale-100"
                          }`}
                        >
                          <svg
                            className={`w-5 h-5 ${
